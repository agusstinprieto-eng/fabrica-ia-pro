...
export const INDUSTRIAL_OPERATIONS: Record<IndustrialMode, Record<string, Omit<Operation, 'stationId'>[]>> = {
    ...
    aerospace: {
        'avionics': [
            ...
            { id: 'av-5', name: 'Safety Guard', code: 'QA-01', time: 10.0, category: 'inspection' },
        ],
        'fuselage': [
    ...
    textile: {
        'jeans': [
            { id: 'jean-1', name: 'Coser Entrepierna', code: 'OP 5.8', time: 12.5, category: 'sewing' },
            { id: 'jean-2', name: 'Pegar Bolsillos', code: 'OP 7.4', time: 18.3, category: 'sewing' },
            { id: 'jean-3', name: 'Coser Lateral', code: 'OP 5.9', time: 14.2, category: 'sewing' },
            { id: 'jean-4', name: 'Poner Cierre', code: 'OP 8.6', time: 22.5, category: 'sewing' },
            { id: 'jean-5', name: 'Pespunte', code: 'OP 6.7', time: 15.8, category: 'sewing' },
            { id: 'jean-6', name: 'Pretina', code: 'OP 7.9', time: 11.2, category: 'sewing' },
            { id: 'jean-7', name: 'Ruedo', code: 'OP 9.1', time: 9.5, category: 'sewing' },
            { id: 'jean-8', name: 'Botón/Remache', code: 'OP 10.3', time: 4.8, category: 'assembly' },
        ],
        'tshirt': [
            { id: 'tsh-1', name: 'Coser Hombros', code: 'OP 5.2', time: 6.3, category: 'sewing' },
            { id: 'tsh-2', name: 'Pegar Mangas', code: 'OP 7.1', time: 9.5, category: 'sewing' },
            { id: 'tsh-3', name: 'Cerrar Costados', code: 'OP 5.6', time: 8.1, category: 'sewing' },
            { id: 'tsh-4', name: 'Ribete Cuello', code: 'OP 6.4', time: 10.2, category: 'sewing' },
            { id: 'tsh-5', name: 'Ruedo Manga', code: 'OP 7.3', time: 5.4, category: 'sewing' },
            { id: 'tsh-6', name: 'Ruedo Base', code: 'OP 9.1', time: 7.8, category: 'sewing' },
        ],
        'safety_jacket': [
            { id: 'sj-1', name: 'Coser Reflejante', code: 'OP 4.1', time: 15.0, category: 'sewing' },
            { id: 'sj-2', name: 'Unión Espalda', code: 'OP 5.2', time: 22.0, category: 'sewing' },
            { id: 'sj-3', name: 'Cerrar Hombros', code: 'OP 5.4', time: 18.5, category: 'sewing' },
            { id: 'sj-4', name: 'Colocar Cierre', code: 'OP 8.2', time: 45.0, category: 'sewing' },
            { id: 'sj-5', name: 'Pegar Mangas', code: 'OP 7.1', time: 28.0, category: 'sewing' },
