                ...
                <div className="max-w-3xl mx-auto space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[10px] text-slate-600 leading-relaxed text-justify">
                        <div>
                            ...
                            Fabrica IA Pro assumes no liability for decisions made based on this automated analysis.
                            <p className="text-[9px] text-slate-500 italic mt-1 leading-relaxed">
                                Fabrica IA Pro no asume ninguna responsabilidad por las decisiones tomadas con base en este análisis automatizado.
                            </p>
                        </div>
                        <div>
