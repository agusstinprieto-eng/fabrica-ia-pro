...
const GALLERY_ITEMS: GalleryItem[] = [
    ...
    // Generic Industries
    {
        ...
        category: 'Industries',
        description: 'Debris-free assembly area with smart torque tracking.',
    ...
    },
    {
        ...
        category: 'Industries',
        description: 'Industry-standard compliant automated bottling and blistering line.',
        imageUrl: '/gallery/sector-pharma-branded.png',
        tags: ['Pharma', 'Standard', 'Clean Room'],
        location: 'Global Mfg Hub',
    },
    {
        id: 'ind7',
        ...
        category: 'Industries',
        description: 'Industrial Safety standard high-speed bottling and packaging.',
        imageUrl: '/gallery/sector-food-branded.png',
        tags: ['Food', 'Safety', 'Bottling'],
        location: 'Global Mfg Hub',
    },
    {
        id: 'ind8',
